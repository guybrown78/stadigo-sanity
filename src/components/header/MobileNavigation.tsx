...
function MobileNavIcon({ open }:Props) {
  return (
    <svg
      aria-hidden="true"
    ...
    <Popover>
      ...
      <Transition.Root>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Popover.Overlay className="fixed inset-0 bg-slate-950 bg-opacity-60" />
        </Transition.Child>
        <Transition.Child
          as={Fragment}
          enter="duration-150 ease-out"
        ...
        >
          ...
          >
            ...
            <hr className="m-2 border-slate-200" />

            <MobileNavLink href="/stadigo-pioneer-program">Join our Pioneer Program</MobileNavLink>
          </Popover.Panel>
        </Transition.Child>
      </Transition.Root>
    </Popover>
